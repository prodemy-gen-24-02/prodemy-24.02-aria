...
const ProductCard = ({ product, addItem }) => {
   ...
   return (
      <div className="flex flex-col border rounded-lg m-1 bg-white justify-center p-4">
         
         <div className="justify-center h-48 w-48">
            <img className="h-48 object-contain" src={product.image} />
