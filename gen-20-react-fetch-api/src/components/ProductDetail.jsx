    ...
    return (
        ...
        <div class="flex flex-row items-center pl-4">
                    ...
                    <div class="flex flex-col min-h-96 shadow-xl lg:w-1/2 w-full lg:my-4 p-4">
                        <div class="mx-auto">
                            <div class="flex flex-col space-y-4 content-center p-4">
                                ...
                                <h2 class="font-bold text-2xl font-sans">{toRupiah(product.price-product.discount-1000)}</h2>
                                
                                <h2 class={`text-gray-500 text-lg line-through ${(product.discount<=100000) ? "hidden" : "flex"}`}>{toRupiah(product.price-1000)}</h2>
                            ...
                            <div class="flex flex-row items-center">
                                <section class="flex items-center p-2">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <button aria-label="Decrease" class="h-8 px-4 ml-2 text-sm text-gray-900 bg-gray-300 rounded-none"
                                            onClick={() => {setQuantity(quantity-1)}}>-</button>
                                          
                                        <input id="quantity" class="w-1/4 text-center border-gray-300 border-2 h-8" type="number" value={quantity} />
                                        <button aria-label="Increase" class="h-8 px-4 mr-2 text-sm text-gray-900 bg-gray-300 rounded-none"
                                            onClick={() => {setQuantity(quantity+1)}}>+</button>
                                    </div>
                                </section>
            ...
            <div class="flex flex-col content-center w-11/12 mx-auto shadow-xl my-5 p-4  bg-white">
                <span class="flex p-4 bg-gray-100 w-full">Informasi Produk</span>
