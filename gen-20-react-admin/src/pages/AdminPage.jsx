...
function AdminPage({ columns, data }) {
        ...
        (info) => {
            return (
                ...
                <tr className="border-b text-center">
                    ...
                    <td><button className='bg-gray-300'>edit</button><button className='bg-gray-300'>delete</button></td>
                </tr>
            )
        }
    )
        ...
        <div className="flex flex-row">
            ...
            <div>
                ...
                <div className="flex justify-center">
                    ...
                    <table className="table-auto bg-white my-10">
